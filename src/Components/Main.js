            ...
            <>
                {
                    ...
                    <div>
                        <h3 className="text-center" style={{fontSize: "60px", fontWeight: "bold", color: "rgb(36, 9, 9)", margin: "15px"}}>Trending</h3>
                        <div className="movies-list" style={{display:'flex-wrap',justifyContent:'center'}}>
                            {
                                this.state.movies.map((movieObj)=>(
                                    <div className="card movies-card" style={{height: "100px", width: "100px"}}  onMouseEnter={()=>this.setState({hover:movieObj.id})} onMouseLeave={()=>this.setState({hover:''})}>
